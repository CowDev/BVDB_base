...
function bvdb_footer() {
	return 'Thank you for choosing <a href="https://www.burovoordeboeg.nl/" target="_blank">Buro voor de Boeg</a>.';
}
add_filter( 'admin_footer_text', 'bvdb_footer', 11 );
